...
type BulletedRequest = Extract<BlockObjectRequest, { type?: "bulleted_list_item" }>
type NestedChild = NonNullable<
  NonNullable<BulletedRequest["bulleted_list_item"]>["children"]
>[number]
 ...
 */
export function parseNestedBulletedListItemToken(item: Tokens.ListItem): NestedChild {
